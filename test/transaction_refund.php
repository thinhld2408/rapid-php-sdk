...
$transaction_id = $createTransactionResponse->getTransactionID();
$refundResponse = $rapidSDKClient->refundTransaction($transaction_id, new Refund(array(
    "Refund" => new RefundDetails(array(
        "TotalAmount" => $createTransactionResponse->getPayment()->getTotalAmount()
    ))
)));

print_r($refundResponse->toArray());
