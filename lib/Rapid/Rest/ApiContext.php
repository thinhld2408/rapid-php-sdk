...
class ApiContext
{
     ...
     * If the value is not set, it would get the value from @\Rapid\Core\RapidCredentialManager
     *
     * @var \Rapid\Auth\OAuthTokenCredential
     */
    private $credential;
     ...
     * Get Credential
     *
     * @return \Rapid\Auth\OAuthTokenCredential
     */
    ...
    /**
     * Resets the requestId that can be used to set the Rapid-request-id
     ...
     * can be used to set the Rapid-Request-Id header
