...
class LoggingManager
{
    ...
    public function __construct()
    {
        ...
        if ($this->isLoggingEnabled) {
            ...
            $this->loggingLevel =
                (isset($loggingLevel) && defined(__NAMESPACE__ . "\\LoggingLevel::$loggingLevel")) ?
                constant(__NAMESPACE__ . "\\LoggingLevel::$loggingLevel") :
                LoggingManager::DEFAULT_LOGGING_LEVEL;
        }
    }
